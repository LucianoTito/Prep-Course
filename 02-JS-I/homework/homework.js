...
function suma(x, y) { return x + y;  // Suma "x" e "y" juntos y devuelve el valor
  // Tu código: 
...
function esImpar(num) { if(num% 3 ) {return true; } return false
...
function elevar(num, exponent) { return Math.pow(num, exponent )  // Devuelve el valor de "num" elevado al exponente dado en "exponent"
  // Tu código:
...
function esPositivo(numero) { if (numero> 0 )  return "Es positivo"; if (numero< 0 ) return "Es negativo"; if (numero=== 0 ) return false;
...
function agregarSimboloExclamacion(str) { var frase = str + "!"; return frase;
...
function areaDelTriangulo(base, altura){ var semiarea= base*altura; var area= semiarea/2; return area;
...
function esVocal(letra){ 
  ...
  //Escribe tu código aquí 
  if (letra.length> 1) return "Dato incorrecto"; if (letra=== "a" ) return "Es vocal"; if (letra=== "e" ) return "Es vocal"; 
  if (letra=== "i") return "Es vocal"; if (letra=== "o") return "Es vocal"; if (letra=== "u") return "Es vocal"; else return "Dato incorrecto";
};
