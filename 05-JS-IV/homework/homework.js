// No cambies los nombres de las funciones.
 ...
 function crearGato (nombre, edad)  {  var cat= { nombre: nombre,
edad: edad,
...
function multiplicarNumeroDesconocidoPorCinco (objetoMisterioso) { var producte = objetoMisterioso.numeroMisterioso * 5
  return producte
...
function nuevoUsuario (nombre, email, password) { var user = { nombre: nombre,
email: email,
password: password,}
return user
